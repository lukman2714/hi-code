...
Route::get('/admin', [AdminController::class, 'index'])->middleware('role:user')->name('admin.index');
Route::get('/admin/{id}/edit', [AdminController::class, 'edit'])->name('admin.edit');
Route::get('/pengguna', [AdminController::class, 'getpengguna'])->middleware('role:user');
Route::get('/pengguna/{id}', [AdminController::class, 'getPenggunaById'])->middleware('role:user');
Route::delete('/pengguna/{id}', [AdminController::class, 'deletePengguna'])->middleware('role:user');

Route::put('/pengguna/{id}', [AdminController::class, 'update'])->name('admin.update')->middleware('role:user');

Route::get('/admin/create', [AdminController::class, 'create'])->middleware('role:user')->name('admin.create');
Route::post('/admin/store', [AdminController::class, 'store'])->middleware('role:user')->name('admin.store');
...
Route::resource('resep', \App\Http\Controllers\CabangController::class);
...
Route::get('/api/cabang', [CabangController::class, 'getCabang']);
